...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-lqeq3a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-lqeq3a.containers.anotherwebservice.com/
...
```
git clone git@github.com:qreytol/container-lqeq3a.git
cd container-lqeq3a
```
...
```
docker attach container-lqeq3a
```
